...
export default function FinanceiroPage() {
  ...
  useEffect(() => {
    ...
    const stats = useMemo(() => {
      ...
      const netProfit = totalProjected - totalExpenses;
      const profitMargin = totalReceived > 0 ? (grossProfit / totalReceived) * 100 : 0;
      ...
      {loading ? (
        ...
        <main className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="rounded-[2rem] border-none shadow-xl shadow-red-200/30 bg-gradient-to-br from-red-500 to-red-600 text-white overflow-hidden">
              <CardContent className="p-8">
                <div className="flex items-start justify-between">
                  <div className="flex flex-col gap-1">
                    <span className="text-[10px] font-black text-white/60 uppercase tracking-[0.2em]">Despesas</span>
                    <span className="text-4xl font-black tracking-tighter">R$ {stats.totalExpenses.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
                  </div>
                  <div className="w-14 h-14 rounded-2xl bg-white/20 flex items-center justify-center">
                ...
                <div className="mt-6 flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full w-fit">
                  <div className="w-2 h-2 rounded-full bg-white" />
                  <span className="text-[9px] font-bold uppercase tracking-widest">Este Mês: R$ {stats.thisMonthExpenses.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
                </div>
              </CardContent>
            </Card>

            <Card className="rounded-[2rem] border-none shadow-xl shadow-green-200/30 bg-gradient-to-br from-green-500 to-green-600 text-white overflow-hidden">
              <CardContent className="p-8">
                <div className="flex items-start justify-between">
                  <div className="flex flex-col gap-1">
                    <span className="text-[10px] font-black text-white/60 uppercase tracking-[0.2em]">Lucro Bruto</span>
                    <span className="text-4xl font-black tracking-tighter">R$ {stats.grossProfit.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
                  </div>
                  <div className="w-14 h-14 rounded-2xl bg-white/20 flex items-center justify-center">
                ...
                <div className="mt-6 flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full w-fit">
                  <div className="w-2 h-2 rounded-full bg-white" />
                  <span className="text-[9px] font-bold uppercase tracking-widest">Receitas - Despesas</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-[2rem] border-none shadow-xl shadow-purple-200/30 bg-gradient-to-br from-purple-500 to-purple-600 text-white overflow-hidden">
              <CardContent className="p-8">
                <div className="flex items-start justify-between">
                  <div className="flex flex-col gap-1">
                    <span className="text-[10px] font-black text-white/60 uppercase tracking-[0.2em]">Margem de Lucro</span>
                    <span className="text-4xl font-black tracking-tighter">{stats.profitMargin.toFixed(1)}%</span>
                  </div>
                  <div className="w-14 h-14 rounded-2xl bg-white/20 flex items-center justify-center">
                ...
                <div className="mt-6 flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full w-fit">
                  <div className="w-2 h-2 rounded-full bg-white" />
                  <span className="text-[9px] font-bold uppercase tracking-widest">Rentabilidade</span>
                </div>
              </CardContent>
            </Card>
          </div>
