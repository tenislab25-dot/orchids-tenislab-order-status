...
import { Edit2, ShoppingBag, Search, ArrowLeft, Loader2, Plus } from "lucide-react";
...
export default function ProductsManagement() {
  ...
  const [newProduct, setNewProduct] = useState({ name: "", category: "Acessórios", price: 0, stock_quantity: 0, description: "" });
