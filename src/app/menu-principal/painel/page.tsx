      ...
      >
        <Card
          onClick={(e) => {
            ...
            router.push(`/menu-principal/os/${order.os_number.replace("/", "-")}`);
          }}
...
{(role === "ADMIN") && (
              ...
              <Link href="/menu-principal/calendario" prefetch={false}>
            ...
            {(role === "ADMIN" || role === "ATENDENTE") && (
              <>
                ...
                <Link href="/menu-principal/todos" prefetch={false}>
                ...
                <Link href="/menu-principal/os" prefetch={false}>
              ...
              <Card className="border-purple-200 bg-purple-50 rounded-2xl shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <Link href="/menu-principal/entregas" prefetch={false}>
